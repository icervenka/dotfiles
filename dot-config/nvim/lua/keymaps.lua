...
-- folding
map("n", "<F9>", "za", { desc = "Fold in normal mode" })
map("i", "<F9>", "<C-o>za", { desc = "Fold in insert mode" })
map("o", "<F9>", "<C-c>za", { desc = "Fold in operator-pending mode" })
map("v", "<F9>", "zf", { desc = "Fold in visual mode" })
...
-- Telescope and Harpoon Mappings
